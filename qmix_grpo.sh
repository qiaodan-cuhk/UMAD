...
# 设置算法和config name
export CONFIG_NAME="qmix_trainer"  # ippo/grpo/remax
...
WANDB_RUN_NAME="Confidence-gain_MATH_qwen2.5-3b_qwen3-4b-base_0.1sample_tmp0.7_topp0.95_traj-grpo_IPPOwarmup_100_reward${AGG_MODE}_team-${TEAM_REWARD_TYPE}_${ALGORITHM_NAME}_bs64_p5k_r2k_2turn_${TD_MODE}_$DATE_TIME"
