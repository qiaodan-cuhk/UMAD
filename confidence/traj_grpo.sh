...
# 设置算法和config name
export CONFIG_NAME="confidence"  # ippo/grpo/remax
...
AGG_MODE="ind"  # sum 代表加和，max代表取最大，dictator代表强模型,ind代表自己用自己的
TEAM_REWARD_TYPE="dense"  # dense/sparse/accumulative 

# 设置WandB相关变量
WANDB_PROJECT="qmix_grpo"
WANDB_RUN_NAME="test_confidence"
VAL_BEFORE_TRAIN=False




ROLLOUT_DATA_DIR=/root/code/maverl/conf_logs
echo "###### Running Test with $ALGORITHM_NAME and $CONFIG_NAME ######"
# 设置TensorBoard日志目录
TENSORBOARD_DIR="conf_results/$WANDB_RUN_NAME"
