...
WANDB_RUN_NAME="GSM8K_qwen0.5b-instruct_2IPPO_a100_sumreward"

# 设置TensorBoard日志目录
export TENSORBOARD_DIR="/root/code/maverl/results/$WANDB_RUN_NAME/events"


# 运行训练
python3 -m verl.trainer.main_ippo_naive \
