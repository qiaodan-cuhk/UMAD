...
# The controller owns the per-agent PPO wrappers: self.mac.agents = [PPO, PPO, ...].
class BasicMAC_Hetero:
    ...
    def __init__(self,
                 ...
                 processor_list: Optional[List] = None,  # Per-agent processor list.
                 **kwargs):
    ...
    def _build_agent_config(self, agent_id):
        ...
        # Synchronize model-dependent paths for this agent-specific config.
    ...
    def _build_agents(self):
        ...
        # Build one PPO agent wrapper per MARL agent.
        self.agents = []
        ...
        # Qwen3-style thinking can be disabled independently per agent.
        ...
        for agent_id in range(self.num_agents):
            ...
            # Convert global MARL roles back to local PPO worker roles.
            ...
            self.agents.append(agent_cls(agent_id=agent_id, 
                                            config=agent_config,  # Supports heterogeneous agent configs.
