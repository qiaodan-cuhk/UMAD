...
USE_KL=true # 是否使用kl penalty in rewards
...
WANDB_RUN_NAME="GSM8K_qwen0.5b_${ALGORITHM_NAME}${SUM_REWARD_FLAG}${CORY_FLIP_FLAG}${USE_KL_FLAG}_8a100_$DATE_TIME"

echo "###### Running Test with $ALGORITHM_NAME and $CONFIG_NAME ######"

# 设置TensorBoard日志目录
TENSORBOARD_DIR="results/$WANDB_RUN_NAME"
