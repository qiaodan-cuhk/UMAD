        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer('step', timing_raw):
                    ...
                    reward_tensor_all = self.learner.cal_influence_intrinsic_reward(multi_turn_batchs, reward_tensor_all, metrics)
    ...
    def _get_dialogue_data_grpo(self, multi_turn_batchs, num_agents, turns, reward_tensor_all, log_nums=5):
        ...
        for log_idx in range(log_nums):
            ...
            for turn_idx in range(turns):
                ...
                # turn_sample_nums = int(self.rollout_n ** (turn_idx+1))  # 该turn的样本数量，这里是tree GRPO的结构
                turn_sample_nums = int(self.rollout_n)  # 该turn的样本数量，适配traj GRPO结构
