...
class RayMAGRPOTrainer:
    ...
    def __init__(self,
        ...
        self.buffer = MultiAgentTurnReplayBuffer(num_agents=self.num_agents, capacity=10000)
            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer('step', timing_raw):
                    ...
                    with _timer('gen', timing_raw):
                        # 这是grpo版本rollout
                        if self.config.algorithm.adv_estimator == "grpo":
                            # self.runner.rollout_multi_turn_grpo(gen_batch_all, multi_turn_batchs, metrics, turn=self.turns)
                            # magrpo版本rollout，总计 n 条轨迹
                            self.runner.rollout_multi_turn_magrpo(gen_batch_all, multi_turn_batchs, metrics, turn=self.turns)
                        # else:
                    ...
                    reward_tensor_all, reward_extra_infos_dict_all, future_reward_all = self.runner.cal_reward_magrpo(multi_turn_batchs, metrics)
